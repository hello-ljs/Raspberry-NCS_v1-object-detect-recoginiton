...
int main()
{
   time_t t = time( 0 );
	...
	FILE *rfp = fopen("/home/pi/workspace/main/tmp_yuv/out_480_nonfifo.yuv","rb");
	if(NULL == rfp)
    ...
    char str[240];
    strcpy (str,"/home/pi/workspace/main/out_allima/");
    strcat (str,tmpBuf);
	yuv420p_to_jpeg(str,pData,1280,720,100);
